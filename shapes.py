...
class Mesh(Shape):
    ...
    def intersect(self, ray):
        ...
        for i in range(0, len(self.indices), 3):
            ...
            curr_hit = self.triangle_intersect(ray, v0, v1, v2)
        ...
        if closest_hit != 1000000000.0:
            return (closest_hit, self.triangle_normal(final_v0, final_v1, final_v2), self.material)
        else:
            return (-1, None, None)
    ...
    def triangle_intersect(self, ray, v0, v1, v2):
        v0v1 = v1 - v0
        v0v2 = v2 - v0
        pvec = glm.cross(ray.direction, v0v2)
...
class Sphere(Shape):
    ...
    def intersect(self, ray):
        ...
        return (t, self.normal(ray.origin + t*ray.direction), self.material) if t != -1.0 else (t, None, None)
